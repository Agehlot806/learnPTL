                                    ...
                                    <Row>
                                        <Col lg={6} sm={6}>
                                            <div className="iconcoin-mask-bg-wrap iconcoin-mask-bg-wrap-1 mb-4 mb-lg-0">
                                                <img className="ico-image-sm top_image_bounce" src={shape6} alt="img" />
                                                <img className="ico-shape-image" src={shape4} alt="img" />
                                                <div className="thumb top_image_bounce"><img src={Img3} alt="img" />
                                                </div>
                                            </div>
                                        </Col>
                                        <Col lg={6} sm={6}>
                                            <div className='find-tutors'>
                                                ...
                                                <Row className='mb-4'>
                                                    ...
                                                    <Col lg={5} className='align-self-center mt-4'>
                                                        <Button onClick={nextStep} className="theme-button1 mt-1" hoverColor="theme-button1" label="Get Started" icon="fa fa-long-arrow-right" iconPosition="right" />
                                                    </Col>
                                                </Row>
                                                <Link to="">I want to choose from 17,222 Tutors <i className='fa fa-long-arrow-right' /></Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </Container>
                                    ...
                                    <section className="section-padding">
                                        <div className="presearch-option-select">
                                            <div className="text-right">
                                                <Link onClick={nextStep}>Skip <i className="fa fa-angle-double-right" /></Link>
                                            </div>
                                            <div className="presearch-option">
                                                <Row>
                                                    <Col lg={1} sm={1}>
                                                        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M5.674 15a6.951 6.951 0 0 1-.603-2H11v2H5.674ZM7.1 17a6.98 6.98 0 0 0 3.9 1.93V17H7.101Zm5.9 0v1.93A6.98 6.98 0 0 0 16.899 17H13Zm5.326-2a6.952 6.952 0 0 0 .603-2H13v2h5.326ZM13 11h5.93a6.952 6.952 0 0 0-.604-2H13v2Zm3.899-4H13V5.07A6.98 6.98 0 0 1 16.899 7ZM7.101 7H11V5.07A6.98 6.98 0 0 0 7.101 7ZM11 9H5.674a6.951 6.951 0 0 0-.603 2H11V9Zm1-6a9 9 0 1 0 0 18 9 9 0 0 0 0-18Z" clip-rule="evenodd"></path></svg>
                                                    </Col>
                                            ...
                                            <div className="presearch-option">
                                                <Row>
                                                    <Col lg={1} sm={1}>
                                                        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 19a7 7 0 1 1 0-14 7 7 0 0 1 0 14Zm-9-7a9 9 0 1 1 18 0 9 9 0 0 1-18 0Zm8-3H8v3h3V9Zm2 0h3v3h-3V9Zm-1 8a5.001 5.001 0 0 0 4.584-3H7.416A5.001 5.001 0 0 0 12 17Z" clip-rule="evenodd"></path></svg>
                                                    </Col>
                                                    <Col lg={10} sm={10} className="align-self-center">
                                            ...
                                            <div className="presearch-option">
                                                <Row>
                                                    <Col lg={1} sm={1}>
                                                        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 19a7 7 0 1 1 0-14 7 7 0 0 1 0 14Zm-9-7a9 9 0 1 1 18 0 9 9 0 0 1-18 0Zm7-2 6-2-2 6-6 2 2-6Zm3 2a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" clip-rule="evenodd"></path></svg>
                                                    </Col>
                                                    <Col lg={10} sm={10} className="align-self-center">
                                                        <h6>Living abroad</h6>
                                                    </Col>
                                            ...
                                            <div className="presearch-option">
                                                <Row>
                                                    <Col lg={1} sm={1}>
                                                        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="m14 3 .707.707 2 2 .707.707-.707.707-10 10-.293.293H3V14l.293-.293 10-10L14 3ZM5 14.828v.586h.586l7.207-7.207-.586-.586L5 14.828Zm9 6.586H3v-2h11v2Zm7 0h-5v-2h5v2Z" clip-rule="evenodd"></path></svg>                                            </Col>
                                                    <Col lg={10} sm={10} className="align-self-center">
                                            ...
                                            <div className="presearch-option">
                                                <Row>
                                                    <Col lg={1} sm={1}>
                                                        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9 3H7v3H3v14h18V6h-4V3H9Zm6 2H9v1h6V5ZM9 8h6v10H9V8Zm10 10h-2V8h2v10ZM7 8H5v10h2V8Z" clip-rule="evenodd"></path></svg>                                            </Col>
                                                    <Col lg={10} sm={10} className="align-self-center">
                            ...
                            <Row>
                                ...
                                <div className='all-overlay-bg'>
                                            <div className="get-start-bg">
                                                <Button onClick={prevStep} className='white-button' icon="fa fa-arrow-left" iconPosition="left" label={strings.back}></Button>
                                                <div class="typewriter-area">
                                                    <div class="typewriter">What's your English level?</div>
                                                </div>
                                                <img className="top_image_bounce" src={Goals} />
                                            </div>
                                        </div>
                            ...
                            <Row>
                                ...
                                <div className='all-overlay-bg'>
                                            <div className="get-start-bg">
                                                <Button onClick={prevStep} className='white-button' icon="fa fa-arrow-left" iconPosition="left" label={strings.back}></Button>
                                                <div class="typewriter-area">
                                                    <div class="typewriter">Looking for a best accent?</div>
                                                </div>
                                                <img className="top_image_bounce" src={Goals} />
                                            </div>
                                        </div>
                            ...
                            <Row>
                                ...
                                <div className='all-overlay-bg'>
                                            <div className="get-start-bg">
                                                <Button onClick={prevStep} className='white-button' icon="fa fa-arrow-left" iconPosition="left" label={strings.back}></Button>
                                                <div class="typewriter-area">
                                                    <div class="typewriter">When can you take lessons?</div>
                                                </div>
                                                <img className="top_image_bounce" src={Goals} />
                                            </div>
                                        </div>
                            ...
                            <Row>
                                ...
                                <div className='all-overlay-bg'>
                                            <div className="get-start-bg">
                                                <Button onClick={prevStep} className='white-button' icon="fa fa-arrow-left" iconPosition="left" label={strings.back}></Button>
                                                <div class="typewriter-area">
                                                    <div class="typewriter">What's your budget per lesson?</div>
                                                </div>
                                                <img className="top_image_bounce" src={Goals} />
                                            </div>
                                        </div>
