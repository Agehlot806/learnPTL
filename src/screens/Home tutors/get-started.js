...
function Getstarted() {
  ...
  const countrysData = countrys.slice(0, 5);
  const countrysDataSeeAll = countrys.slice(5);
  ...
  const stepFirst = [
    {
      icond:
        "M5.674 15a6.951 6.951 0 0 1-.603-2H11v2H5.674ZM7.1 17a6.98 6.98 0 0 0 3.9 1.93V17H7.101Zm5.9 0v1.93A6.98 6.98 0 0 0 16.899 17H13Zm5.326-2a6.952 6.952 0 0 0 .603-2H13v2h5.326ZM13 11h5.93a6.952 6.952 0 0 0-.604-2H13v2Zm3.899-4H13V5.07A6.98 6.98 0 0 1 16.899 7ZM7.101 7H11V5.07A6.98 6.98 0 0 0 7.101 7ZM11 9H5.674a6.951 6.951 0 0 0-.603 2H11V9Zm1-6a9 9 0 1 0 0 18 9 9 0 0 0 0-18Z",
      title: "Career and business",
    },
    {
      icond:
        "M12 19a7 7 0 1 1 0-14 7 7 0 0 1 0 14Zm-9-7a9 9 0 1 1 18 0 9 9 0 0 1-18 0Zm8-3H8v3h3V9Zm2 0h3v3h-3V9Zm-1 8a5.001 5.001 0 0 0 4.584-3H7.416A5.001 5.001 0 0 0 12 17Z",
      title: "Lessons for kids",
    },
    {
      icond:
        "M12 19a7 7 0 1 1 0-14 7 7 0 0 1 0 14Zm-9-7a9 9 0 1 1 18 0 9 9 0 0 1-18 0Zm7-2 6-2-2 6-6 2 2-6Zm3 2a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z",
      title: "Living abroad",
    },
    {
      icond:
        "m14 3 .707.707 2 2 .707.707-.707.707-10 10-.293.293H3V14l.293-.293 10-10L14 3ZM5 14.828v.586h.586l7.207-7.207-.586-.586L5 14.828Zm9 6.586H3v-2h11v2Zm7 0h-5v-2h5v2Z",
      title: "Exams and course work",
    },
    {
      icond:
        "M9 3H7v3H3v14h18V6h-4V3H9Zm6 2H9v1h6V5ZM9 8h6v10H9V8Zm10 10h-2V8h2v10ZM7 8H5v10h2V8Z",
      title: "Culture, travel and hobby",
    },
  ];
  const [selectedOption, setSelectedOption] = useState(null);

  // Function to handle selection of radio buttons
  const handleOptionChange = (event) => {
    setSelectedOption(event.target.value);
  };

  // Log the selected option to the console when it changes
  ...
  const stepThird = [
    ...
    { title: "I'm fluent in most situations" },
  ];
  const [selectedOptionThirdStep, setSelectedOptionThirdStep] = useState(null);

  // Function to handle selection of radio buttons
  const handleThirdStepChange = (event) => {
    setSelectedOptionThirdStep(event.target.value);
  };
  console.log("selectedOptionThirdStep: ", selectedOptionThirdStep);
  // STEP THIRD END
  // STEP FOURTH END
  ...
  const handleCountryChange = (event) => {
    ...
    if (isChecked) {
      setSelectedOptionCountry([...selectedOptionCountry, value]);
    } else {
      setSelectedOptionCountry(
        selectedOptionCountry?.filter((item) => item !== value)
      );
    }
  };
  console.log("selectedOptionCountry: ", selectedOptionCountry);
  // STEP FOURTH END
  // STEP FIVETH START
  const [selectedOptionSpecialties, setSelectedOptionSpecialties] = useState(
    []
  );

  // Function to handle selection of radio buttons
  const handleSpecialtiesChange = (event) => {
    // setSelectedOptionSpecialties(event.target.value);
    const value = event.target.value;
    const isChecked = event.target.checked;

    if (isChecked) {
      setSelectedOptionSpecialties([...selectedOptionSpecialties, value]);
    } else {
      setSelectedOptionSpecialties(
        selectedOptionSpecialties?.filter((item) => item !== value)
      );
    }
  };
  console.log("selectedOptionSpecialties: ", selectedOptionSpecialties);
  // STEP FIVETH END
  // STEP TIME AND WEEKS SECTION START
  const [selectedOptionTimes, setSelectedOptionTimes] = useState([]);
  const [selectedOptionWeeks, setSelectedOptionWeeks] = useState([]);
  ...
  const handleTimesChange = (event) => {
    ...
    if (isChecked) {
      setSelectedOptionTimes([...selectedOptionTimes, value]);
    } else {
      setSelectedOptionTimes(
        selectedOptionTimes?.filter((item) => item !== value)
      );
    }
  };
  console.log("selectedOptionTimes: ", selectedOptionTimes);
  const weekList = [
    { week: "Sun" },
    { week: "Mon" },
    { week: "Tue" },
  ...
  const handleWeeksChange = (event) => {
    ...
    if (isChecked) {
      setSelectedOptionWeeks([...selectedOptionWeeks, value]);
    } else {
      setSelectedOptionWeeks(
        selectedOptionWeeks?.filter((item) => item !== value)
      );
    }
  };
  console.log("selectedOptionWeeks: ", selectedOptionWeeks);
  // STEP TIME AND WEEKS SECTION END
                          ...
                          <Row>
                            ...
                            <Col lg={1} sm={1}>
                              <Form.Check
                                ...
                                id={`formHorizontalRadios${index}`} // Ensure unique IDs for each radio button
                                value={item.title} // Assuming you want to use the title as the value
                          ...
                          <Row>
                            ...
                            <Col lg={1} sm={1}>
                              <Form.Check
                                ...
                                id={`formHorizontalRadios${index}`} // Ensure unique IDs for each radio button
                                value={item.title} // Assuming you want to use the title as the value
                                onChange={handleThirdStepChange}
                              />
                            </Col>
                          </Row>
                        </div>
                ...
                <Col lg={6} className="">
                  <section className="section-padding">
                    <div className="presearch-option-select">
                          ...
                          <Row>
                            ...
                            <Col lg={1} sm={1}>
                              <Form.Check
                                ...
                                name="formHorizontalRadios"
                                id={`formHorizontalRadios${index}`} // Ensure unique IDs for each radio button
                                value={item.country} // Assuming you want to use the title as the value
                      ...
                      <Link onClick={() => setShowAllData(!showAllData)}>
                        {showAllData ? "Hide" : "Show all"}
                      </Link>
                      {showAllData &&
                        countrysDataSeeAll.map((item, index) => (
                          <div className="presearch-option" key={index}>
                            <Row>
                              <Col lg={1} sm={1}>
                                <img src={Au} />
                            ...
                            <>
                              ...
                              <Col lg={1} sm={1}>
                                <Form.Check
                                  ...
                                  name="formHorizontalRadios"
                                  id={`formHorizontalRadios${index}`} // Ensure unique IDs for each radio button
                                  value={item.specialties} // Assuming you want to use the title as the value
                      ...
                      <div className="day-timeScroll">
                                ...
                                <Row>
                                  ...
                                  <Col lg={6} sm={6}>
                                    <Form.Check
                                      type="checkbox"
                                      id={`formHorizontalRadios${index}`} // Ensure unique IDs for each radio button
                                      value={item.time} // Assuming you want to use the title as the value
                        ...
                        <Row>
                          ...
                          {weekList.map((item, index) => (
                            <Col lg={2} sm={2} className="mb-3" key={index}>
                                ...
                                <Row>
                                  ...
                                  <Col lg={6} sm={6}>
                                    <Form.Check
                                      type="checkbox"
                                      id={`formHorizontalRadios${index}`} // Ensure unique IDs for each radio button
                                      value={item.week} // Assuming you want to use the title as the value
