                            ...
                            <div className='section-padding'>
                                <div className="sign-content">
                                    ...
                                    <Form>
                                        ...
                                        <Button className="theme-button1 w-100 mt-3" hoverColor="theme-button1" label={strings.SignupwithEmail} />
                                        <Button className="red-button w-100 mt-3" hoverColor="red-button" icon="fa fa-google" label={strings.SignUpwithGooglebtn} />
                                        <Button className="red-button w-100 mt-3" hoverColor="red-button" icon="fa fa-facebook" label={strings.SignUpwithFacebook} />
                                    </Form>
                                </div>
                            </div>
