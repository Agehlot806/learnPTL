          ...
          <Nav className="nav-menus ms-auto my-2 my-lg-0">
            ...
            <Nav.Link onClick={() => setModalShow(true)}>
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M4 6h14v2h-4a4 4 0 000 8h4v2H4V6zm16 10v4H2V4h18v4h2v8h-2zm-8-4a2 2 0 114 0 2 2 0 01-4 0z"
                  clipRule="evenodd"
                />
              </svg>{" "}
              Balance: 0 lessons
            </Nav.Link>
            <Balance show={modalShow} onHide={() => setModalShow(false)} />
            <Nav.Link>
              <Link to="/wishlist">
                <i className="fa fa-heart-o" />
              </Link>
            </Nav.Link>
            <Nav.Link onClick={() => setnotificationShow(true)}>
              <Link>
