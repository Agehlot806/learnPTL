...
import Topinstructor from '../../assets/images/icons/top-instructor.png';
                    ...
                    <Row>
                        <Col lg={8} sm={9} xs={7}>
                            <div className='d-flex main-heading'>
                                <div>
                                    <img className='teamimg' src={Topinstructor} />
                                </div>
                                <div>
                                    <h1>Top Rated Courses From Our Top Instructor.</h1>
                        ...
                        <Col lg={4} sm={3} xs={5}>
                            <div className='bolderrightText'>
                                <Link to=''>
                                    <Button className='bolderBtn' label="View All Instructor" icon="fa fa-long-arrow-right" iconPosition="right" />
                                </Link>
                            </div>
                        </Col>
                    </Row>
